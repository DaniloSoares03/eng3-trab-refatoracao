...
public abstract class Usuario implements Serializable, Comparable<Usuario> {
    ...
    private static final String STATE_BLOCKED = "BLOQUEADO";
    private static final String STATE_UNBLOCKED = "DESBLOQUEADO";
    private static final String LOAN_STATE_OVERDUE = "ATRASADO";
    ...
    public void atualiaEstado() {
        ...
        if (estaBloqueado(hoje)) {
            this.estado = "BLOQUEADO";
        } else if (temEmprestimoAtrasado()) {
            this.estado = "BLOQUEADO";
        } else {
            this.bloqueadoAte = null;
            this.estado = "DESBLOQUEADO";
    ...
    private boolean estaBloqueado(Date hoje) {
    	return this.bloqueadoAte != null && this.bloqueadoAte.getTime() > hoje.getTime() - Constans.ATRAZO_PADRAO;
    }

    private boolean temEmprestimoAtrasado() {
