...
public class AdicionarContaFrame extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        if (camposObrigatoriosPreenchidos() && senhasIguais()) {
            if (aluno) {
                adicionarAluno();
            } else {
    ...
    private boolean camposObrigatoriosPreenchidos() {
        if (this.nomejTextField1.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "O Campo Nome é Obrigatório!");
            return false;
        }
        
        if (this.matriculajFormattedTextField.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "O Campo Matricula é Obrigatório!");
            return false;
        }
        
        if (this.CPFjFormattedTextField.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "O Campo CPF é Obrigatório!");
            return false;
        }
        
        if (this.senhajPasswordField.getText().isEmpty() || this.outraSenhajPasswordField.getText().isEmpty()) {
    ...
    private boolean senhasIguais() {
        if (!this.senhajPasswordField.getText().equals(this.outraSenhajPasswordField.getText())) {
    ...
    private void adicionarAluno() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao adicionar aluno: " + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void adicionarFuncionario() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao adicionar funcionário: " + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
    }
